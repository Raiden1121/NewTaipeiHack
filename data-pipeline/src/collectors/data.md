...
預設使用新北市資料開放平台 CSV API，保留完整來源資料；可依區篩選。若只需要住宅租賃，請明確傳入 `residential_only=True`，排除車位、土地、店面與辦公室類型。

```python
from collectors.rental_price import fetch_rental_prices

records = fetch_rental_prices()                 # 新北市完整租賃來源
records = fetch_rental_prices(district="板橋區")
records = fetch_rental_prices(residential_only=True)   # 只保留住宅租賃
...
2026-09-09 以 CSV 實際呼叫，完整來源取得 44,852 筆、涵蓋 27 區；以下為前 5 筆：

| 區域 | 租賃類型 | 租賃年月日 | 建物面積（平方公尺） | 租金總額 | 租金／平方公尺 | 租金／坪 |
|---|---|---:|---:|---:|---:|---:|
| 五股區 | 獨立套房 | 1140428 | 83.56 | 16800 | 201 | 664.462785 |
| 五股區 | 獨立套房 | 1140503 | 30.37 | 8900 | 293 | 968.595005 |
| 五股區 | 整戶 | 1140428 | 120.4 | 18000 | 150 | 495.86775 |
| 新莊區 | 整戶 | 1140421 | 105.17 | 22000 | 209 | 690.909065 |
| 泰山區 | 整戶 | 1140502 | 134.5 | 22200 | 165 | 545.454525 |
...
預設使用新北市資料開放平台 CSV API，資料已包含 `district`，不需逐區呼叫。預設保留完整來源交易；若只需要住宅買賣，請明確傳入 `residential_only=True`，排除土地、車位、純建物、店面與辦公用途。

```python
from collectors.house_price import fetch_house_prices

records = fetch_house_prices()                      # 新北市完整買賣來源
records = fetch_house_prices(district="板橋區")
records = fetch_house_prices(residential_only=True)   # 只保留住宅買賣
...
2026-09-09 以 CSV 實際呼叫，完整來源取得 50,065 筆、涵蓋新北市 29 區；以下為前 5 筆：

| 區域 | 交易標的 | 交易年月日 | 建物面積（平方公尺） | 總價 | 單價／平方公尺 | 單價／坪 |
|---|---|---:|---:|---:|---:|---:|
| 林口區 | 房地(土地+建物) | 1130102 | 264.87 | 38880000 | 146721 | 485252.874365 |
| 土城區 | 房地(土地+建物)+車位 | 1130106 | 99.01 | 14800000 | 171985 | 568515.68116 |
| 新店區 | 房地(土地+建物)+車位 | 1130107 | 149.14 | 30450000 | 234388 | 774555.342855 |
| 土城區 | 房地(土地+建物)+車位 | 1130108 | 119.8 | 18850000 | 171773 | 567814.85474 |
| 土城區 | 房地(土地+建物)+車位 | 1130112 | 125.54 | 19320000 | 172632 | 570466.09431 |
