...
export default function FertilityDistributionMap() {
  ...
  function handlePointerDown(event: ReactPointerEvent<SVGSVGElement>) {
    ...
    // 不在 pointerdown 就 setPointerCapture：那會把後續 click 事件改派到 <svg>，
    // 導致 <path> 的 onClick 永遠不觸發。改為真正拖曳後（見 handlePointerMove）再捕捉。
        ...
        {isLoading ? (
          ...
          <div className="relative overflow-hidden rounded-xl border border-slate-200 bg-slate-50">
            <svg
              ...
              role="img"
              aria-label="新北市 29 行政區青年生育分布互動地圖，可縮放、平移與點選行政區"
              className={cn(
            ...
            >
              ...
              >
                {features.map((district) => {
                  ...
                  const fertilityRate = districtById.get(id)?.fertilityRate;
                    ...
                    <path
                      ...
                      style={{
                        fill: isSelected
                          ...
                          : fertilityFillColor(fertilityRate),
                        strokeWidth:
